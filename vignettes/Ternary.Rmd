...
_Ternary_ is an R package to allow the creation of ternary plots in the standard
...
[Shiny App](https://ternary.shinyapps.io/plot).

For greater control over your plots, use R.
