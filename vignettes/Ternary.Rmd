...
Note that the location of axis labelling has been modified on this plot using 
...
I hope that the package comes in useful.  

If there's anything it can't do that you wish
it could, please let me know by opening a [Github issue](https://github.com/ms609/Ternary/issues/new?title=Suggestion:+).
