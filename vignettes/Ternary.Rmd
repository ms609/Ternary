...
```{r sub-plot}
TernaryPlot(clip = list(
  c(0, 10), # range of a coordinates to display
  c(0, 20), # b range; the largest range will be applied to all axes
  75 # c axis will be centred on this single value
  )
)
