...
For a point-and-click plotting experience, you can use the Shiny app:
```r
install.packages('shiny')
install.packages('Ternary')
shiny::runGitHub('TernaryApp', 'ms609')
```

This app is under development and does not yet implement the full functionality
or flexibility of the full R package.
Do [request](https://github.com/ms609/TernaryApp/issues/new?title=Missing+feature:+)
that I add any features that are presently lacking.
