...
Finally, as the data are a series, we might wish to plot the trend as a line:
...
TernarySegments(Seatbelts[-nPoints, seat], Seatbelts[-1, seat],
                col = rowCol, lwd = 2)

# Label each point by its month
TernaryText(Seatbelts[, seat], month.abb, cex = 0.6,
            # Semi-transparent colours
            col = adjustcolor(rowCol, alpha.f = 0.8))
```