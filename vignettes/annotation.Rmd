...
Where less control is required over the location of individual annotations,
labels can be added and positioned automatically.
...
Annotate(points[, 1:3], label = seq_along(points[, 1]), col = points[, "col"])
```
