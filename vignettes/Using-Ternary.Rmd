...
values <- TernaryDensity(coordinates, resolution=10L)
ColourTernary(values)
TernaryPoints(coordinates, col='#ff000066', pch='.')
#TernaryContour(FunctionToContour, resolution=36L)

```


```{r low-resolution-density-contours}
...
TernaryPlot(grid.lines=3, axis.labels=1:3)
