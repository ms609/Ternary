...
By default, the plotting area is a 1x1 square.  In the right-pointing orientation,
the x-axis ranges from just under 0 to just over sqrt(3)/2, and the y axis from -0.5 to +0.5.
