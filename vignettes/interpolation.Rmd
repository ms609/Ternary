...
A ternary plot can be coloured and contoured according to a known function:
...
response <- FunctionToContour(abc['a', ], abc['b', ], abc['c', ])
...
TernaryContour(PredictABC, resolution = 3L)

# Mark measured points
TernaryPoints(abc, pch = 3)
```
